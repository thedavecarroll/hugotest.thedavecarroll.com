...
In 2012, I started working with someone that {{< link id="ilovepsh" text="loved PowerShell">}} as much as I did. We challenged each other and learned from it. I wrote functions and dot-sourced them in my profile. I started dabbling in modules, but just didn't make the time to delve fully into them.
...
_I've had the domain `anovelidea.org` since early 2000. If you want a break from PowerShell and IT in general, you can check out {{< link id="my-personal-site" text="my other website">}}._
